...
<div class="row-fluid">
	<div class="page__search-bar">
		<div class="main-fluid">
			...
			<span class="sform__intro">Find your perfect property...</span><?php echo do_shortcode( '[bdp mode="sideSearchLetting"]' ); ?>
		</div>
		</div>
	</div>
</div>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div id="listview" class="detail-tab active">
				<?php echo do_shortcode( '[bdp mode="resultsLet"]' ); ?>
			</div>
			<div id="mapview" class="detail-tab">
				<?php echo do_shortcode( '[bdp mode="resultsMapLet"]' ); ?>
			</div>
		</div>
	</div>
</div>
